...
static Key keys[] = {
	...
	{ MODKEY|ShiftMask, 			XK_s, 	   spawn,		   SHCMD("maim -s | xclip -selection c -t image/png")},
	...
	{ MODKEY,						XK_n,	   spawn, 		   SHCMD("pactl set-source-mute $(pactl get-default-source) toggle")},
